...
class OneLogin_Saml2_Auth {
	 ...
	 * @param string $currentUri The current URL
	 *
	 * @throws OneLogin_Saml2_Error
	 */
	public function processResponse($requestId = null, $currentUri = null) {
		$this->_errors = array();
		if (isset($_POST) && isset($_POST['SAMLResponse'])) {
			// AuthnResponse -- HTTP_POST Binding
			$response = new OneLogin_Saml2_Response($this->_settings, $_POST['SAMLResponse']);

			if ($response->isValid($requestId, $currentUri)) {
	 ...
	 * @param bool   $stay       If true the redirect url is returned
	 *
	 * @return string
	 */
	 ...
	 *
	 * @return array [string $url, OneLogin_Saml2_AuthnRequest $authNRequest]
	 */
